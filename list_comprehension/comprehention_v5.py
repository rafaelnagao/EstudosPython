...
# Exemplo 5: Criar um dicionário usando dict comprehension para mapear números pares de 0 a 9 aos seus quadrados:
dicionario = {i: i * 2 for i in range(10) if i % 2 == 0}
print(dicionario) # Saída: {0: 0, 2: 4, 4: 16, 6: 36, 8: 64}

for numero, dobros in dicionario.items():
    print(f"Número: {numero}, Dobro: {dobros}")